...
import com.mobile.fatah.themoviedbupnow.adapter.AdapterRecyclerview;
import com.mobile.fatah.themoviedbupnow.fragment.NowPlayingFragment;
import com.mobile.fatah.themoviedbupnow.fragment.UpComingFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Upcoming Movie").setIcon(R.drawable.ic_menu_gallery));
        tabLayout.addTab(tabLayout.newTab().setText("Now Playing Movie").setIcon(R.drawable.ic_menu_gallery));
